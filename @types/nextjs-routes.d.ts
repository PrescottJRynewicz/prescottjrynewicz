...
declare module "nextjs-routes" {
  ...
  export type Route =
    | StaticRoute<"/404">
    | DynamicRoute<"/api/blog/posts/[postId]", { "postId": string }>
    | DynamicRoute<"/api/blog/posts/[postId]/like", { "postId": string }>
    | DynamicRoute<"/api/blog/posts/[postId]/view", { "postId": string }>
    | StaticRoute<"/api/images/proxy">
