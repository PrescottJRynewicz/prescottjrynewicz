    ...
    <main>
      ...
      <img 
        ...
        <div class="event-description">
            ...
            <p class="price-option">- Come anytime between 10 and 12:30! We'll be hanging here until we leave for the park around 1.00</p>
            <p class="event-item">• <span class="event-highlight">1 PM - Brooklyn Bridge Park:</span> Picnic, volleyball, and outdoor fun at <a href="https://www.google.com/maps?q=Harbor+View+Lawn,+80+Furman+St,+Brooklyn,+NY+11201&ftid=0x89c25a399f38e70b:0xde47bc3d2609b8fe&entry=gps&lucs=,94224825,94227247,94227248,94231188,47071704,47069508,94218641,94203019,47084304,94208458,94208447&g_ep=CAISEjI1LjE2LjEuNzQ3NTI2NjMwMBgAIIgnKmMsOTQyMjQ4MjUsOTQyMjcyNDcsOTQyMjcyNDgsOTQyMzExODgsNDcwNzE3MDQsNDcwNjk1MDgsOTQyMTg2NDEsOTQyMDMwMTksNDcwODQzMDQsOTQyMDg0NTgsOTQyMDg0NDdCAlVT&skid=4e5ab8fe-f65f-4896-881f-64b50195f88d&g_st=com.google.maps.preview.copy" target="_BLANK">BK Bridge Park</a> (walk or bike from the Rynochin household)</p>
            <p class="price-option">- Bring blankets, chairs, and any usual park hang items you like to have!</p>
            <p class="price-option">- Because we'll be walking/biking from our place, don't bring so much stuff that you'll be uncomfortable carrying it.</p>
